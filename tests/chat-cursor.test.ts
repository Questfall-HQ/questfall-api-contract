...
test('chat exposes an exact read cursor and a boolean unread signal',()=>{
 ...
 const status={has_unread:true,read_cursor:cursor,attention_unread:2,online:5,frequent:[],can_mention_everyone:false}
...
test('chat returns up to twenty-one recent reaction emoji',()=>{
 ...
 const status={has_unread:false,read_cursor:null,attention_unread:0,online:0,frequent,can_mention_everyone:false}
