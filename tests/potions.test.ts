...
const potion={id:'potion',kind:'potion',slot:'',wear:'',rarity:'d',level:0,weight:241,location:'inventory',location_ref:'',potion:{type:'stamina',restore_percent:90},aspect:{value:{raw:0,effective:0,boost:0,boosted:false}},perks:[]};
